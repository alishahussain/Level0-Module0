...
if __name__ == '__main__':
    ...
    statement = messagebox.showinfo(title= 'mad libs', message= 'If you find yourself having to cross a piranha-infested river, heres how to do it...')
    # Get the player to enter an adjective
    adjective =  simpledialog.askstring(title='adj' , prompt='put in an adjective')
    # Get the player to enter a type of liquid
    liquid =  simpledialog.askstring(title='liquid' , prompt='put in a type of liquid')
    # Get the player to enter a body part
    body =  simpledialog.askstring(title='body' , prompt='put in a body part')
    # Get the player to enter a verb
    verb =  simpledialog.askstring(title='verb' , prompt='put in a verb')
    # Get the player to enter a place
    place =  simpledialog.askstring(title='place' , prompt='put in a place')
    ...
    messagebox.showinfo(title="final", message=story)
